...
export const ENGLISH_UNITED_STATES: Record<PROFILE, string> = {
    ...
    [PROFILE.CONNECT_SERVICE]: "CONNECT_SERVICE",
    [PROFILE.UNKNOWN_ERROR]: "UNKNOWN_ERROR",
    [PROFILE.FAILED_TO_FETCH]: "FAILED_TO_FETCH",
    [PROFILE.FAILED_TO_FETCH_DESCRIPTION]: "FAILED_TO_FETCH_DESCRIPTION",
    [PROFILE.USERNAME_PASSWORD_NOT_MATCH]: "USERNAME_PASSWORD_NOT_MATCH",
    [PROFILE.TWO_FA_NOT_MATCH]: "TWO_FA_NOT_MATCH",
    [PROFILE.TWO_FA_NOT_MATCH_DESCRIPTION]: "TWO_FA_NOT_MATCH_DESCRIPTION",
    [PROFILE.TOO_MANY_ATTEMPT]: "TOO_MANY_ATTEMPT",
    [PROFILE.INTERNAL_ERROR]: "INTERNAL_ERROR",
    [PROFILE.INTERNAL_ERROR_DESCRIPTION]: "INTERNAL_ERROR_DESCRIPTION",
};
